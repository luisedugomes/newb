...
A Arenarank é uma plataforma web que organiza torneios/campeonatos amadores de jogos digitais específicos (Lol,Valorant e CS:G0 2). 

O seu sistema irá permitir que o usuário crie/participe de equipes e organize campeonatos, tendo como diferencial, uma interface prática com ferramentas que facilitam a experiêcia do mesmo.
...
- [🖼️ Protótipo no Stitch](https://stitch.withgoogle.com/u/2/projects/1097575403078761773?pli=1) - Telas interativas da aplicação.
...
- **API - Challengermode (GraphQL):** - Consiste na transferência de dados das funcionalidades necessárias para a criação e manipulação dos torneios;
